...
import type { MCPClient } from '../../src/mcp-client/client.js';

vi.mock('../../src/mcp-client/client.js', async () => {
  const actual = await vi.importActual('../../src/mcp-client/client.js');
  return {
    ...(actual as object),
...
import { LatencyProfilingCheck } from '../../src/doctor/checks/latency-profiling.check.js';
import { AuthVerificationCheck } from '../../src/doctor/checks/auth-verification.check.js';
import { PayloadLimitsCheck } from '../../src/doctor/checks/payload-limits.check.js';
import { TimeoutBehaviorCheck } from '../../src/doctor/checks/timeout-behavior.check.js';
import { ErrorFormatCheck } from '../../src/doctor/checks/error-format.check.js';
import { ConcurrencyStressCheck } from '../../src/doctor/checks/concurrency-stress.check.js';
...
describe('All Diagnostic Checks', () => {
  ...
  describe('AuthVerificationCheck', () => {
    ...
    it('detects unauthenticated request acceptance', async () => {
      const { createDoctorClient } = await import('../../src/mcp-client/client.js');
