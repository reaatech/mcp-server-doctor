...
import type { runDiagnoseCommand as RunDiagnoseCommandType } from '../../src/cli/commands/diagnose.command.js';
import type { runCompareCommand as RunCompareCommandType } from '../../src/cli/commands/compare.command.js';
import type { runWatchCommand as RunWatchCommandType } from '../../src/cli/commands/watch.command.js';

vi.mock('../../src/cli/commands/diagnose.command.js', () => ({
  runDiagnoseCommand: vi.fn().mockResolvedValue(undefined),
}));

vi.mock('../../src/cli/commands/compare.command.js', () => ({
  runCompareCommand: vi.fn().mockResolvedValue(undefined),
}));

vi.mock('../../src/cli/commands/watch.command.js', () => ({
...
describe('CLI entry point', () => {
  ...
  it('parses diagnose command with arguments', async () => {
    ...
    const { runDiagnoseCommand } = await import('../../src/cli/commands/diagnose.command.js');
  ...
  it('parses compare command with arguments', async () => {
    ...
    const { runCompareCommand } = await import('../../src/cli/commands/compare.command.js');
    await import('../../src/cli.js');
  ...
  it('parses watch command with arguments', async () => {
    ...
    const { runWatchCommand } = await import('../../src/cli/commands/watch.command.js');
    await import('../../src/cli.js');
